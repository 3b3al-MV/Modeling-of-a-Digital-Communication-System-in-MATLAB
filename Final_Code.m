...
title('BPSK: Simulated vs Theoretical');
...
title('QPSK: Simulated vs Theoretical');
legend('Simulated BER', 'Theoretical BER');
xlabel('Eb/No (dB)');
ylabel('BER');
...
title('8PSK: Simulated vs Theoretical');
legend('Simulated BER', 'Theoretical BER');
xlabel('Eb/No (dB)');
ylabel('BER');
...
title('QAM: Simulated vs Theoretical');
legend('Simulated BER', 'Theoretical BER');
xlabel('Eb/No (dB)');
ylabel('BER');
...
legend('BPSK', 'Theoretical BPSK', 'QPSK', 'Theoretical QPSK', '8PSK', 'Theoretical 8PSK', '16-QAM', 'Theoretical 16-QAM');
xlabel('Eb/No (dB)');
ylabel('BER');
...
title('BER of Gray Code QPSK vs Binary Code QPSK');
